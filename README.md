...
```sh
  git clone https://github.com/paulshaun-kdtk/Ruby_Capstone_Catalogue_Of_Things.git
  cd Ruby_Capstone_Catalogue_Of_Things
```
...
- GitHub: [@omwomwo](https://github.com/Omwomo)
